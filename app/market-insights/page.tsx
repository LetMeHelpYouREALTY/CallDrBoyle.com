...
export async function generateMetadata(): Promise<Metadata> {
  return generateMarketingMetadata("/market-insights", {
  title: "Las Vegas Real Estate Market Insights 2026 | Berkshire Hathaway HomeServices",
  description:
    `Technology trends, economic forecasts, and market analysis shaping Las Vegas real estate in 2026. AI, data centers, California migration, and what it means for buyers and sellers. Call {agentInfo.phoneFormatted}.`,
  keywords: [
