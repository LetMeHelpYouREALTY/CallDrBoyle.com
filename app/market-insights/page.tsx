...
export async function generateMetadata(): Promise<Metadata> {
  ...
  description:
    "Technology trends, economic forecasts, and market analysis shaping Las Vegas real estate in 2026. AI, data centers, California migration, and what it means for buyers and sellers. Call (949) 638-3939.",
  keywords: [
