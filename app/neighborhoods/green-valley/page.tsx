...
export async function generateMetadata(): Promise<Metadata> {
  return generateMarketingMetadata("/neighborhoods/green-valley", {
  title: "Berkshire Hathaway HomeServices Green Valley | Henderson Real Estate",
  description:
    `Find Green Valley homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in Henderson's most established community. Median price $520K. Call {agentInfo.phoneFormatted}.`,
  keywords: [
