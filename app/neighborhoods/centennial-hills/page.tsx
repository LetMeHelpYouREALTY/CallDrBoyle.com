...
export async function generateMetadata(): Promise<Metadata> {
  return generateMarketingMetadata("/neighborhoods/centennial-hills", {
  title: "Berkshire Hathaway HomeServices Centennial Hills | Las Vegas Homes",
  description:
    `Find Centennial Hills homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in this established northwest community. Median price $495K. Call {agentInfo.phoneFormatted}.`,
  keywords: [
