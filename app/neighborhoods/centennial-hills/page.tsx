...
export async function generateMetadata(): Promise<Metadata> {
  ...
  description:
    "Find Centennial Hills homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in this established northwest community. Median price $495K. Call (949) 638-3939.",
  keywords: [
