...
export async function generateMetadata(): Promise<Metadata> {
  return generateMarketingMetadata("/neighborhoods/henderson", {
  title: "Berkshire Hathaway HomeServices Henderson | Nevada Real Estate",
  description:
    `Find Henderson homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in Henderson's family-friendly communities. Median price $485K. Call {agentInfo.phoneFormatted}.`,
  keywords: [
