...
export async function generateMetadata(): Promise<Metadata> {
  ...
  description:
    "Find Henderson homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in Henderson's family-friendly communities. Median price $485K. Call (949) 638-3939.",
  keywords: [
