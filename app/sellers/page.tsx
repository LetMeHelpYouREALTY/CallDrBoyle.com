...
export async function generateMetadata(): Promise<Metadata> {
  ...
  description:
    `Sell your Las Vegas or Henderson home for top dollar with Dr. Jan Duffy at Berkshire Hathaway HomeServices Nevada Properties. Free home valuation. World-class marketing. Call {agentInfo.phoneFormatted}.`,
  keywords: [
    "sell home Las Vegas",
