...
export async function generateMetadata(): Promise<Metadata> {
  return generateMarketingMetadata("/home-valuation", {
  title: "Free Home Valuation Las Vegas | What's Your Home Worth? | Berkshire Hathaway HomeServices",
  description:
    `Get a free, accurate home valuation in Las Vegas from Dr. Jan Duffy at Berkshire Hathaway HomeServices. Expert CMA analysis for Summerlin, Henderson, Green Valley & all Las Vegas neighborhoods. Call {agentInfo.phoneFormatted}.`,
  keywords: [
