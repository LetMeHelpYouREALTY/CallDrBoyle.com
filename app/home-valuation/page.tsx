...
export async function generateMetadata(): Promise<Metadata> {
  ...
  description:
    "Get a free, accurate home valuation in Las Vegas from Dr. Jan Duffy at Berkshire Hathaway HomeServices. Expert CMA analysis for Summerlin, Henderson, Green Valley & all Las Vegas neighborhoods. Call (949) 638-3939.",
  keywords: [
