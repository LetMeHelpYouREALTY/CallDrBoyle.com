...
export async function generateMetadata(): Promise<Metadata> {
  return generateMarketingMetadata("/buyers/luxury-homes-las-vegas", {
  title: "Luxury Homes Las Vegas | Berkshire Hathaway HomeServices",
  description:
    `Las Vegas luxury real estate from $1.2M to $10M+. Guard-gated estates, Strip penthouses, and custom homes. Dr. Jan Duffy provides discrete, expert representation. Call {agentInfo.phoneFormatted}.`,
  keywords: [
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            >
              ...
              Schedule a Private Preview → {agentInfo.phoneFormatted}
            </a>
          </div>
