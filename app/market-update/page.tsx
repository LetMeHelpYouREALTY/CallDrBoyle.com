...
export async function generateMetadata(): Promise<Metadata> {
  return generateMarketingMetadata("/market-update", {
  title: "Berkshire Hathaway HomeServices Las Vegas Market Update | January 2026",
  description:
    `Weekly Las Vegas real estate market update from Berkshire Hathaway HomeServices Nevada Properties. Get the latest stats, notable sales, and expert analysis from Dr. Jan Duffy. Call {agentInfo.phoneFormatted}.`,
  keywords: [
