...
export async function generateMetadata(): Promise<Metadata> {
  ...
  description:
    `Solera at Anthem - intimate guard-gated 55+ community in Henderson. Homes from $380K-$650K. Lower HOA fees, close-knit atmosphere. Dr. Jan Duffy, BHHS. Call {agentInfo.phoneFormatted}.`,
  keywords: [
