...
export async function generateMetadata(): Promise<Metadata> {
  ...
  description:
    `Nevada's largest 55+ community. Sun City Summerlin homes from $320K-$850K. 3 golf courses, 4 rec centers, 100+ clubs. Dr. Jan Duffy, BHHS specialist. Call {agentInfo.phoneFormatted}.`,
  keywords: [
