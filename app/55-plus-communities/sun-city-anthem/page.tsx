...
export async function generateMetadata(): Promise<Metadata> {
  ...
  description:
    `Henderson's premier 55+ community. Sun City Anthem homes from $350K-$1.2M. 2 championship golf courses, stunning mountain views. Dr. Jan Duffy. Call {agentInfo.phoneFormatted}.`,
  keywords: [
