...
export async function generateMetadata(): Promise<Metadata> {
  ...
  description:
    `Free buyer representation on new construction homes in Las Vegas. Dr. Jan Duffy helps you navigate builder contracts, negotiate upgrades, and secure incentives. Call {agentInfo.phoneFormatted}.`,
  keywords: [
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: `Yes, most builders require your agent to accompany you or be registered on your FIRST visit. If you visit alone and sign the guest registry, you may forfeit your right to free representation. Call {agentInfo.phoneFormatted} to register Dr. Jan Duffy as your buyer's agent before visiting any model home.`,
      },
    },
    {
      "@type": "Question",
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-amber-800 text-sm">
                    ...
                    Call <a href={agentInfo.phoneTel} className="font-bold underline">{agentInfo.phoneFormatted}</a> to 
      ...
      <RealScoutOfficeListings />
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Call <strong>{agentInfo.phoneFormatted}</strong> to register Dr. Jan Duffy as your buyer's agent 
