import { getSitePhoneDisplay } from "@/lib/site-contact";
/**
...
- Include contact information when appropriate: ${getSitePhoneDisplay()}
...
- Always include contact information for Dr. Jan Duffy: ${getSitePhoneDisplay()}
...
## Contact
Dr. Jan Duffy: ${getSitePhoneDisplay()}`,
  cacheable: true,
  estimatedTokens: 650,
};
...
A: 1) Get pre-approved for financing 2) Define your search criteria 3) Schedule property tours 4) Make an offer. I can guide you through each step. Call ${getSitePhoneDisplay()} to start.

**Q: What's my home worth?**
A: I provide free, no-obligation home valuations. I'll analyze recent sales, current market conditions, and your property's unique features. Call ${getSitePhoneDisplay()} to schedule.
...
- Include contact: ${getSitePhoneDisplay()}

## Escalation
For complex questions or when you're unsure, always recommend speaking directly with Dr. Jan Duffy at ${getSitePhoneDisplay()}.`,
  cacheable: true,
  estimatedTokens: 450,
};
