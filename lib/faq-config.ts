...
export const FAQ_BY_PAGE_TYPE: Record<string, FAQ[]> = {
  ...
  luxury: [
    ...
    { question: "How discreet is the buying process for high-value properties?",
      answer: "Very. Dr. Jan regularly handles off-market transactions and can structure showings privately. Many luxury listings in Las Vegas never appear on the public home search websites — call 702-222-1964 for confidential access." },
  ...
  search: [
    { question: "How current is your local listing data?",
      answer: "Dr. Jan pulls directly from the Las Vegas home search, which updates every 15 minutes. Unlike public portals that can lag 24–72 hours, you'll see new listings, price drops, and status changes in real time when working with her directly." },
    { question: "What's the fastest way to find a home before it sells?",
      answer: "Set up a personalized home search. Dr. Jan sets up automated alerts matched to your exact criteria — you get notified the moment a qualifying home hits the market, often before buyers using public portals even see it." },
  ...
  investment: [
    ...
    { question: "How do I identify undervalued investment properties?",
      answer: "Dr. Jan watches for estate sales, divorce sales, and out-of-state owners who've let properties sit. She also tracks price-per-square-foot anomalies by neighborhood. Her investor clients get off-market alerts before properties hit the public home search websites." },
